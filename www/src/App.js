...
class App extends Component {
  ...
  componentDidMount() {
    import('../node_modules/rustfractals')
      .then(wasm => { return wasm.wasmdraw(1000, 1000, 100); })
      .catch(e => console.log("error: ", e))
      .then(result => {
        this.setState({ fractalArray: this.getPixelsArray(result) });
        this.updateCanvas();
      });
  }
  ...
  render() {
    ...
    return (
      <div className="App container-fluid">
        <canvas className="fractal" ref="canvas" id="fractal" width="1000" height="1000"></canvas>
      </div>
    );
  }
}
